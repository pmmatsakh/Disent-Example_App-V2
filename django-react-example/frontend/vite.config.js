...
//
//  • PRODUCTION (what deploys): `npm run build` emits dist/, and the Django
...
//    5178 and proxies /api/* to the backend on 8004 — so fetch("/api/hello")
//    still hits Django while you edit with HMR. Requires the backend running.
