...
// /api/hello from the Django backend (same origin, so no CORS) and renders the
...
export default function App() {
  ...
  return (
    <main className="card">
      <h1>
        👋 hello from <code>django_react</code>
      </h1>
      <div>React frontend · Django backend · one port, no CORS</div>

      <p className="meta">
        The box below is fetched live from <code>/api/hello</code> on the
        Django backend that also serves this page.
      </p>
