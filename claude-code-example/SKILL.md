---
name: disent-tile-scaffolder
description: Scaffold a new Disent example tile (app + nginx + homepage tile) from the verified corpus, matching all platform conventions. Use when asked to create a new example/tile/app for the Disent container.
---
